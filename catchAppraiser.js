    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            */
            ...
            const dataUP = (date.getMonth()+1)+'/'+date.getDate()+'/'+date.getFullYear() 
            ...
            let todos = [
                [regridSearched, urlFema, '17', urlRegrid, appraiserUrl, urlGoogle, minimo, taxinfo, dataUP  ,`1`]
            ]
